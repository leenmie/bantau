/*
 * Correct mouse position in case of scaling (added scale y)
 * Added scale calculation in [init] to prevent overhead calculating
 */
...
ig.Input = ig.Class.extend({
	...
	mousemove: function( event ) {		
		...
		this.mouse.x = (ev.clientX - pos.left) / this.scale.x;
		this.mouse.y = (ev.clientY - pos.top) / this.scale.y;
	},
