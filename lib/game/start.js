...
StartGame = ig.Game.extend({ 
    ...
    init_input: function() {
        ...
        this.buttons = new ig.TouchButtonCollection([
            new ig.TouchButton( 'join_room', {left: (ig.system.width - 112)/2, top: 66}, 112, 112, image_button_play, 0 ),
            new ig.TouchButton( 'log_out', {left: 0, bottom: 0}, 40, 40, image_button_quit, 0 ),
