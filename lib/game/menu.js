...
MenuGame = ig.Game.extend({	
	...
	init_input: function() {
		...
		this.buttons = new ig.TouchButtonCollection([
			new ig.TouchButton( 'guest_login', {left: 38, top: 65}, 100, 100, image_button_guest, 0 ),
			new ig.TouchButton( 'facebook_login', {right: 38, top: 65}, 100, 100, image_button_facebook, 0 ),
			new ig.TouchButton( 'music', {right: 0, top: 0}, 40, 40, image_music, 0 )
		]);
	...
	draw: function() {
		...
		this.font.draw("Login", 160, 22, ig.Font.ALIGN.CENTER);
		this.font.draw("Guest", 90, 162, ig.Font.ALIGN.CENTER);
		this.font.draw("Facebook", 237, 162, ig.Font.ALIGN.CENTER);
	}
});
